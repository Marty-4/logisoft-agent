...
console.log('Contient des guillemets ?', key?.includes('"') || key?.includes("'"));
console.log('Affiche les 10 premiers caractères bruts :', JSON.stringify(key?.substring(0, 10)));
...
console.log('Clé brute utilisée :', JSON.stringify(MISTRAL_API_KEY));
console.log('Header Authorization :', `Bearer ${MISTRAL_API_KEY}`);
